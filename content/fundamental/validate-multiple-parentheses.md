+++
title = "Validate multiple parentheses"
template = "level.html"
description = "Validate multiple parentheses using stack"
[extra]
    keywords = "Validate multiple parentheses using stack, learn, explain, tutorial, data structures, algorithms, graph, tree, interview, java, golang, kotlin, python, javascript, rust"
+++
